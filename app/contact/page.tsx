...
export default function ContactPage() {
  return (
    <>
      <PageHero
        eyebrow="CONTACT"
        title="WARSOL Contact"
        description="기술 상담, 제품 자료, 고객 문의"
      />

      <Section eyebrow="Inquiry" title="Technical Inquiry">
      ...
      <Section className="bg-[var(--bg-soft)]" eyebrow="Contact" title="WARSOL 고객센터">
        <div className="grid gap-5 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="surface rounded-lg p-7">
            <h2 className="text-2xl font-black text-[var(--brand-navy)]">Material Inquiry</h2>
            <p className="mt-4 leading-7 text-[var(--muted)]">
              접착, 코팅, 방수, 분산, 친환경 안전소재에 대한 기술 상담과 제품 자료 문의
            </p>
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <DataCard title="Sample" body="샘플 및 적용 상담" />
              <DataCard title="TDS / SDS" body="기술자료와 안전자료" />
              <DataCard title="Technical Support" body="소재 기술 상담" />
            </div>
          </div>
        </div>
      </Section>
